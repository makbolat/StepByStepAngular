...
import { MasterPageComponent } from '../HomePage/CustomerApp.MasterPageComponent';
...
providerscoll.push({ provide: '1', useClass: ConsoleLogger });
...
describe(' when customer add click is working', () => {
  ...
  it('    it shows row count more than 1 in grid', () => {
